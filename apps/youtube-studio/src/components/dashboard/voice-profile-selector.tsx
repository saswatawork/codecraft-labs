            ...
            <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-6">
                {filteredVoices.map((v) => {
                    ...
                    return (
                        <Card
                            key={v.id}
                            className={`border-2 transition-all duration-200 cursor-pointer group hover:shadow-lg h-full flex flex-col ${isSelected
                            ...
                            <CardContent className="p-6 space-y-4 flex flex-col h-full">
                                ...
                                <div className="flex items-start justify-between gap-3">
                                    <div className="flex-1">
                                        <h3 className="font-bold text-base leading-normal text-foreground">
                                            {v.name}
                                        </h3>
                                    </div>
                                    {isSelected && (
                                        <div className="shrink-0">
                                            <Badge
                                                className="gap-1.5 whitespace-nowrap bg-primary text-primary-foreground text-xs py-1.5 px-2.5"
                                            >
