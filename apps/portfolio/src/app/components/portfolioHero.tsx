...
export const PortfolioHero = () => {
  ...
  //       <Hero.Badge className="text-base font-medium">Full-Stack Engineer & Technical Architect</Hero.Badge>
  ...
  //         <Button size="lg" variant="primary" tone="blue" className="px-8 py-4 text-base font-semibold" asChild>
  //           <a href="#projects" className="inline-flex items-center">
  //             View Projects
  //             <ArrowRight className="h-5 w-5 ml-2" />
  //           </a>
  //         </Button>
  //         <Button size="lg" variant="outline-primary" className="px-8 py-4 text-base font-semibold" asChild>
